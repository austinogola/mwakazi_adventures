...
const NewHeader = () => {
  ...
  const igLink =
    "https://www.instagram.com/mwakazi_adventures/profilecard/?igsh=MW02dXltcGQzbndhcw==";
  const tkLink =
    "https://www.tiktok.com/@mwakazi.adventure?_t=8pFsxCr22Mg&_r=1";
  return (
    <header className="newHeader">
        ...
        <div className="contactItem">
          <a href="tel:+254723595924">
            <span className="iconSpan">
              <FiPhoneCall color="#FF6E03" size="18px" />
            </span>
      ...
      <div className="socialMedia">
        <a href={ytLink} target="_blank">
          <span>
            <FiYoutube color="#FF6E03" size="20px" />
          </span>
        </a>

        <a href={igLink} target="_blank">
          <span>
            <FiInstagram color="#FF6E03" size="20px" />
          </span>
        </a>
        <a href={tkLink} target="_blank">
          <span>
            <AiOutlineTikTok color="#FF6E03" size="20px" />
          </span>
        </a>
      </div>
