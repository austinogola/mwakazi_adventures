    ...
    <div className={`side-menu ${isOpen ? 'open' : ''}`}>
      ...
      <nav>
        <ul>
          ...
          {admin?<li>
            <NavLink to="/admin/trips" activeClassName="active-link"
            className={activeLink==='trips'?'active-link':""}>
              Trips
            </NavLink>
          </li>:null}
          {admin?<li>
            <NavLink to="/admin/activities" activeClassName="active-link"
            className={activeLink==='activities'?'active-link':""}>
              Activities
            </NavLink>
          </li>:null}
          {admin?<li>
            <NavLink to="/admin/destinations" activeClassName="active-link"
          ...
          {admin?<li>
            <NavLink to="/admin/invoices" activeClassName="active-link"
            className={activeLink==='invoices'?'active-link':""}>
                Invoices
            </NavLink>
          </li>:null}
          {admin?<li>
            <NavLink to="/admin/pages" activeClassName="active-link"
            className={activeLink==='pages'?'active-link':""}>
                Pages
            </NavLink>
          </li>:null}
          {admin?<li>
            <NavLink to="/admin/blogs" activeClassName="active-link"
            className={activeLink==='blogs'?'active-link':""}>
                Blogs
            </NavLink>
          </li>:null}
          <li>
            <NavLink exact to="/my-bookings" activeClassName="active-link" 
